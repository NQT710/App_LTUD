    ...
    private fun itemClick(){
        ...
        articlesAdapter.setOnItemClickListener(object : ArticlesAdapter.onItemClickListener{
            override fun onItemClick(position: Int) {
                ...
                intent.putExtra("image_articles", listArticles[position].image_articles)
                intent.putExtra("title", listArticles[position].title)
                intent.putExtra("avatar_author", listArticles[position].avatar_author)
                intent.putExtra("name", listArticles[position].name)
                intent.putExtra("day", listArticles[position].day)
                intent.putExtra("tag_articles", listArticles[position].tag_articles)
                intent.putExtra("description_articles", listArticles[position].description_articles)
